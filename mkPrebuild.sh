...
rm "${buildPath}/images/welcomeLogo.blend"
rm "${buildPath}/images/welcomeLogo.blend1"
rm "${buildPath}/images/welcomeLogo2.blend"
rm "${buildPath}/images/welcomeLogo2.blend1"
rm "${buildPath}/images/welcomeLogo3.blend"
rm "${buildPath}/images/welcomeLogo3.blend1"
rm "${buildPath}/libs/ml5.min.js.map"
rm "${buildPath}/libs/ml5.min.js"
